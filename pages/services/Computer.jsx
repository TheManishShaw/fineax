...
const features =[
    ...
    },
    {
        ...
        description:"High-Quality Images in DICOM format extracted from different machines   customized as per requirement by our clients, maintaining all the necessities especially slice thickness, modality of scan, age groups are available along   with clinical reports, de-identified/ PII maintained by our Radiologist and finely sourced."
    },
]
const Computer = () => {
  return (
...
AND POSSIBILITIES
      ...
      <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {features.map((item)=>(
            <div key={item.id} className="flex flex-col justify-between p-5  rounded shadow-sm hover:bg-gray-900 hover:scale-105 transition-all">
            <div>
            ...
            <h6 className="mb-2 font-semibold leading-5 text-white">{item.heading}</h6>
