 ...
 const Banner = (props) => {
    return (
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full bg-gray-900 lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
          <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
            <div className="max-w-xl mb-6">             
              ...
              <p className="text-zinc-100 text-base md:text-lg">{props.description}</p>
            </div>            
          </div>
