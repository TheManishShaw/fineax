    ...
    return (
        <footer className="text-white bg-gray-800 px-4 py-5  mx-auto">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                ...
                Fineax is one stop problem solving in artificial intelligence and machine learning systematically through a range of possible actions in order to reduce the distance of your predefined goal or solution. Our team is skilled through most efficient search strategies and planning an advanced problem solving technique through training and practice and are best at finding good solutions to the competitions.
                </p>
            </div>
